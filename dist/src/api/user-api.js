...
let UserApi = class UserApi extends api_1.SapiRoutableMixin() {
    getUser(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let user;
            try {
                user = yield user_1.User.getById(req.params.id);
            }
            catch (err) {
    ...
    getAllUsers(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let user;
            try {
                user = yield user_1.User.get({ filter: {} });
            }
            catch (err) {
                user = { message: err.message };
            }
    ...
    updateUser(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let user = user_1.User.fromJson(req.body);
            let updateU;
            try {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object, Function]),
    __metadata("design:returntype", Promise)
], UserApi.prototype, "getAllUsers", null);
__decorate([
    api_1.Route({
        method: 'put',
        path: ':id'
